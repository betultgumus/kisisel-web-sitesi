...
export const experienceEntries: DetailEntry[] = [
  {
    ...
    bullets: [
      "AI destekli geliştirme araçlarıyla müşteri gereksinimlerine uygun web arayüzleri geliştiriyorum.",
      "Teknik ve sayfa içi SEO kapsamında meta başlıkları, açıklamaları, içerik yapısını, mobil uyumluluğu ve performansı optimize ediyorum.",
      "Web projelerinde test, hata giderme ve production deployment süreçlerini yürütüyorum.",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Görüntü ön işleme, model eğitimi, inference ve performans değerlendirme süreçlerini yürüttüm.",
      "Model performanslarını PSNR, SSIM ve loss metrikleriyle değerlendirdim ve karşılaştırdım.",
      "Uzak sunucu ortamında eğitim, test ve geliştirme süreçlerinde çalıştım; Git/GitHub ile versiyon kontrolü sağladım.",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Veri temizleme, EDA ve modelleme süreçlerini koordine ederek kod incelemeleri gerçekleştirdim.",
      "2026 MII etkinliğinde veri bilimi projelerinin ekip koordinasyonunu sağladım.",
    ],
  ...
  },
  {
    ...
    bullets: ["Excel ile dashboard tasarladım."],
