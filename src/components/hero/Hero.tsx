  ...
  return (
    <section id="hero" className="hero" aria-labelledby="hero-title">
      ...
      <motion.div className="hero-copy" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.95, ease: [0.22, 1, 0.36, 1] }}>
        <span className="kicker"><i /> Deep Learning</span>
        <h1 id="hero-title" aria-label={profile.fullName}><span className="hero-name-line">Betül Tuba</span><br /><em>Gümüş.</em></h1>
